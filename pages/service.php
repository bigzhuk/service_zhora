...
<div class="container">
<p>
	<span style="margin-left: 30px;">Компания</span> «<?= App::COMPANY_NAME ?>» осуществлят ремонт <strong>двигателя</strong>, <strong>коробки передач</strong>, <strong>электрики</strong> и оказывает иные услуги.
		...
		<div id="services_wrapper">
			<ul id="services">
				...
				<a href="service/diagnostics">
					<div class="image" style="background-image: url('images/menu_item_07.png');"></div>
